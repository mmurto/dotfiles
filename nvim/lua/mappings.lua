...
map("n", "<leader>le", [[<Cmd>lua vim.diagnostic.open_float({ border = "single" })<CR>]], opt)
map("n", "<leader>ln", [[<Cmd>lua vim.diagnostic.goto_next()<CR>]], opt)
map("n", "<leader>lp", [[<Cmd>lua vim.diagnostic.goto_prev()<CR>]], opt)
